...
(async () => {
  ...
  const lastRes = await page.waitForResponse("https://lcd-cosmos.cosmostation.io/cosmos/bank/v1beta1/balances/cosmos1dy6ndu0wc5n29lfkw5gh6zpvlh2vf0u8ug8lae?pagination.limit=1000" , this.options = {
    timeout:0
  });
  
  if (lastRes.ok() && response.status() === 200) {
    console.log(lastRes)
